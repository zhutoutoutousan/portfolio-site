...
- [Portfolio sites](#portfolio-sites)
  ...
  - [Dependencies & ENV](#dependencies--env)
  - [Progress](#progress)
- [APPENDIX: Vue&SCSS study note](#appendix-vuescss-study-note)
  - [Project management](#project-management)
    - [vue.config.js --> Resource management](#vueconfigjs----resource-management)
      - [SCSS](#scss)
    - [scss/css architecture practices](#scsscss-architecture-practices)
    - [Use third party UI library](#use-third-party-ui-library)
...
# APPENDIX: Vue&SCSS study note
Here are my study note of Vue right after finishing this project.
## Project management
