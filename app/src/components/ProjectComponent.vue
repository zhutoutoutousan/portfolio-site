<template>
  <div class="col-1-of-2 project">
      <div class="project__item">
          <img :src="/img/ + project.img" alt="StupidPieceOfShit" class="project__img">
      ...
      <div class="project__background" :class="{'project__background--show': showProject}">
          <div class="project__model" :class="{'project__modal--show':showProject}">
              ...
              <div class="project__left">
                  <img :src="'/img/' + project.img" alt="Project Image" class="project__img--modal">
              </div>
              ...
              <div class="project__right">
                  ...
                  <a :href="project.demo" class="project__button project__button--modal" target="_blank">
                      <font-awesome-icon icon="eye" /> Demo
                  </a>
                  <button href="#" class="project__button project__button--modal" v-if="project.code == 'private'" disabled>
                      <font-awesome-icon icon="code" />Private
                  </button>
                  <a :href="project.code" class="project__button project__button--modal" target="_blank" v-else>
                      <font-awesome-icon icon="code" /> Code
                  </a>
              </div>
          </div>
      </div>
